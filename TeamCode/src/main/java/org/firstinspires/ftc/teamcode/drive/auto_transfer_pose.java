 ...
 */
@Autonomous(name="auto_transfer_pose", group = "advanced")
public class auto_transfer_pose extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-62.7, -31.5, Math.toRadians(0));
        ...
        pose_storage.currentPose = drive.getPoseEstimate();
    }
}
